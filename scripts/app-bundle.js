define('app',['exports'], function (exports) {
  ...
  var App = exports.App = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: '', moduleId: 'login/login', title: 'Login' }, { route: 'welcome', moduleId: 'welcome/welcome', name: 'welcome' }, { route: 'contacts/:id', moduleId: 'contact-detail', name: 'contacts' }]);
...
define('login/login',['exports', 'aurelia-framework', 'aurelia-router'], function (exports, _aureliaFramework, _aureliaRouter) {
	'use strict';
	...
	var Login = exports.Login = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router), _dec(_class = function () {
		...
		Login.prototype.save = function save() {
...
define('welcome/welcome',['exports', 'aurelia-framework', 'aurelia-router'], function (exports, _aureliaFramework, _aureliaRouter) {
	'use strict';
...
define('text!login/login.html', ['module'], function(module) { module.exports = "<template>\n<h3>Login</h3>\n\t<table>\n\t\t<thead>\n\t\t\t<tr>\n\t\t\t\t<th>user name</th>\n\t\t\t\t<th>password</th>\n\t\t\t</tr>\t\n\t\t</thead>\n\t\t<tbody>\n\t\t\t<tr>\n\t\t\t\t<td><input type=\"text\" name=\"username\"></td>\n\t\t\t\t<td><input type=\"password\" name=\"password\"></td>\n\t\t\t\t\n\t\t\t</tr>\n            <tr>\n                <td colspan=\"2\"><button type=\"button\" class=\"btn btn-primary\" click.delegate=\"save()\">Save</button>\n</td>\n            </tr>\n\t\t</tbody>\n\t</table>\n</template>"; });
define('text!welcome/welcome.html', ['module'], function(module) { module.exports = "<template>welcome\n</template>\n"; });
